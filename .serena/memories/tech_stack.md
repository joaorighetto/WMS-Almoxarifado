...
- Frontend: Django Templates (APP_DIRS), HTMX 4.0.0 vendorizado em `static/vendor/htmx/`, fontes woff2 vendorizadas em `static/vendor/fonts/`, CSS próprio com tokens; sem bundler/npm nem CDN.
