...
def test_previa_de_reimportacao_mostra_divergencias_atualizados_e_ausentes_sem_gravar_nada(
    ...
    # Escopados à célula numérica: "10"/"15" soltos casariam com qualquer
    # trecho do HTML (data, CSS, outro CADPRO) e não provariam nada.
    ...
    # "5" solto é substring de "15", já verificado acima — escopado à célula
    # de diferença (com o sinal "+", que só a diferença positiva exibe), como
    # no comentário acima. A classe da célula ganhou `catalogo-diferenca`
    # (revisão do gate visual, achado P2: peso tipográfico como
    # diferenciador não-cromático da diferença) — o regex casa
    # `class="table-cell-numeric ..."` em vez do valor exato da classe.
    assert re.search(
